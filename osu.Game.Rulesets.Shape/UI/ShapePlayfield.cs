...
{
    public class ShapePlayfield : Playfield<ShapeHitObject, ShapeJudgement>
    {
        ...
        public override void Add(DrawableHitObject<ShapeHitObject, ShapeJudgement> h)
        {
        ...
        public override void OnJudgement(DrawableHitObject<ShapeHitObject, ShapeJudgement> judgedObject)
        {
            DrawableShapeJudgement explosion = new DrawableShapeJudgement(judgedObject.Judgement)
            {
