    ...
    public class PokeosuMenu : OsuScreen, IOnlineComponent
    {
        ...
        */
        ...
        private void load(TextureStore textures, Storage storage, DependencyContainer dependencies, APIAccess api)
        {
            ...
            {
                AssetsLoaded = true;
                PokeosuResources = new ResourceStore<byte[]>();
                PokeosuResources.AddStore(new NamespacedResourceStore<byte[]>(new DllResourceStore("osu.Game.Rulesets.Vitaru.dll"), ("Assets")));
                PokeosuResources.AddStore(new DllResourceStore("osu.Game.Rulesets.Vitaru.dll"));

                PokeosuTextures = new TextureStore(new RawTextureLoaderStore(new NamespacedResourceStore<byte[]>(PokeosuResources, @"Textures")));
                PokeosuTextures.AddStore(new RawTextureLoaderStore(new OnlineStore()));
            }
                ...
                StartScreen = new Container
                {
                    ...
                    Children = new Drawable[]
                    {
                        new SpriteText
                        {
                            ...
                            Anchor = Anchor.Centre,
                            Origin = Anchor.Centre,
                            Text = "Welcome to Pokeosu, a tournement based on no one gamemode, but rather the four main gamemodes collectivly!",
                            TextSize = 20,
